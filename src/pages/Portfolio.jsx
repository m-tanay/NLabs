...
const projects = [
  { id:1, category:'Web Design',    title:'E-commerce',       sub:'E-commerce website',   desc:'Full WordPress e-commerce build with a conversion-focused layout, fast load times, and a seamless shopping experience that drives results.', tags:['WordPress','WooCommerce','UI/UX','CRO'], metric:'+38%',  metricLabel:'Conversion rate', accent:'#00f0ff', grad:'linear-gradient(135deg,rgba(0,112,243,.3),rgba(0,240,255,.1))', year:'2024', mockType:'ecom', url:'https://hobinh.com/' },
  { id:2, category:'Web Design',   title:'Healthcare',       sub:'Surrogacy agency website', desc:'Warm, trustworthy website for a surrogacy agency in Sydney. Clear information architecture guides prospective parents and surrogates through a sensitive, life-changing process.', tags:['WordPress','UI/UX','Web Design'], metric:'2×',    metricLabel:'Enquiry rate',    accent:'#7928ca', grad:'linear-gradient(135deg,rgba(121,40,202,.3),rgba(255,0,128,.1))', year:'2024', mockType:'corporate', url:'https://sovereignsurrogacy.com/' },
              ...
              <div className="nb-port-card" style={{'--accent':p.accent}}>
                ...
                <div className="nb-port-info">
                  ...
                  <div className="nb-port-foot">
                    ...
                    <a className="nb-port-link" style={{color:p.accent}} href={p.url || undefined} target={p.url ? '_blank' : undefined} rel={p.url ? 'noopener noreferrer' : undefined}><ExternalLink size={13}/> View case</a>
                  </div>
                </div>
              </div>
            </Reveal>
